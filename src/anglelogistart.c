...
/*******************************************************************************/
void firlogis(double* u, int length, double* z)
{ 
int i;
for(i=0;i<length;i++)
{
...
/*******************************************************************************/
void seclogis(double* u, int length, double* z)
{ 
int i;
for(i=0;i<length;i++)
{
...
void anglelogistart(double* x, double* y, int* kkminus, int* nnobs, int* nnp, double* epsi, double* w, double* warmbeta, double* warminner, double* betaout, double* innerout)
{ 
