...
/*******************************************************************************/
void firlogi(double* u, int length, double* z)
{ 
int i;
for(i=0;i<length;i++)
{
...
/*******************************************************************************/
void seclogi(double* u, int length, double* z)
{ 
int i;
for(i=0;i<length;i++)
{
*z = exp(u[i])/(1+exp(u[i]))/(1+exp(u[i]));
z++;
}
}
...
void anglelogi(double* x, double* y, int* kkminus, int* nnobs, int* nnp, double* lam, double* epsi, double* w, double* warmbeta, double* warminner, double* betaout, double* innerout)
{ 
