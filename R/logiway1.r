logiway1 = function(x, y, weight, nlambda, lambda.min, standardize, epsilon)
{
...
aa = .C("anglelogistart",as.vector((x.train)),as.vector((Y.matrix)),
...
beta0=beta0.trace,beta=beta.trace,loss="logi",way=1)
#---------------------------------------------#
